...
<form class="mt-5 needs-validation" method="post" onSubmit="return validNum()" action="accion/tp2accion4.php" style="width:700px; border:lightgrey 1px solid; margin:auto" novalidate>
